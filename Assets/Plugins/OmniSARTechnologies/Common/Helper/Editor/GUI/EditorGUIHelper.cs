...
namespace OmniSARTechnologies.Helper
{
    public static class EditorGUIHelper
    {
        ...
        {
            public static PropertyAttribute[] GetFieldAttributes<PropertyAttribute>(
                FieldInfo field, bool inherit = true)
            {
                if (null == field)
                {
            ...
            public static PropertyAttribute GetFieldFirstAttribute<PropertyAttribute>(
                FieldInfo field, bool inherit = true)
            {
                if (null == field)
                {
                ...
                SerializedProperty serializedProperty, bool inherit = true)
            {
                ...
                PropertyAttribute[] attributes =
                    GetSerializedPropertyAttributes<Type, PropertyAttribute>(serializedProperty, inherit);
            ...
            public static string GetSerializedPropertyDisplayName<Type>(
                SerializedProperty serializedProperty, bool inherit = true)
            {
                if (null == serializedProperty)
                {
            ...
            public static string GetSerializedPropertyTooltip<Type>(
                SerializedProperty serializedProperty, bool inherit = true)
            {
                if (null == serializedProperty)
                {
            ...
            public static Vector2 GetSerializedPropertyFloatRange<Type>(
                SerializedProperty serializedProperty, bool inherit = true)
            {
                if (null == serializedProperty)
                {
        ...
        {
            public static GUIContent GetSerializedPropertyGUIContent<Type>(
                SerializedProperty serializedProperty, string displayName = default(string))
            {
                if (default(string) == displayName)
                {
                    ...
                    displayName = default(string) == attributeDisplayName
        ...
        public static class Drawing
        {
            ...
            public static void DrawLabel(
                GUIContent content,                    Vector2   position, Vector2 pivot = default(Vector2),
                Color      fontColor = default(Color), FontStyle fontStyle = default(FontStyle), bool dropShadow = true)
            {
            ...
            public static bool DrawMultiValueToggle<Type>(
                SerializedProperty serializedProperty, bool left = false, string displayName = default(string))
            {
                GUIContent label =
                    GUIContentHelper.GetSerializedPropertyGUIContent<Type>(serializedProperty, displayName);
            ...
            public static bool DrawMultiValueObjectField<Type>(
                SerializedProperty serializedProperty, string displayName = default(string),
            ...
            public static bool DrawMultiValueSlider<Type>(
                SerializedProperty serializedProperty, string displayName = default(string))
            {
                GUIContent label =
                    GUIContentHelper.GetSerializedPropertyGUIContent<Type>(serializedProperty, displayName);
            ...
            public static bool DrawWhatsThisFoldout<Type>(
                ref bool folded, SerializedProperty serializedProperty, GUIContent foldoutLabel)
            {
